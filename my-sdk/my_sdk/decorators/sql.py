...
class _SQLDecoratedOperator(DecoratedOperator, SQLExecuteQueryOperator):
    # Merging templated fields from DecoratedOperator and SQLExecuteQueryOperator and adding them in _SQLDecoratedOperator
    ...
    custom_operator_name: "str" = "@task.sql" # We can use this decorator to create sql tasks
